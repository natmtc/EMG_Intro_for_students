...
class offline_EMG(EMG):
    ...
    def open_otb(self, inputfile):
        ...
        temp_dir = "/Users/natal/Desktop/2022-2023/PhD_Q1/Natalia/EMG/temp_tarholder"
...
######################### FAST ICA AND CONVOLUTIVE KERNEL COMPENSATION  ############################################
    ...
    def fast_ICA_and_CKC(self,g,interval,tracker,cf_type = 'square',ortho_type = 'ord_deflation'):
        ...
        print(np.shape(self.decomp_dict['MU_filters'][interval]))
        #self.decomp_dict['MU_filters'][interval][:,self.decomp_dict['SILs'][interval,:] < self.sil_thr] =[]
